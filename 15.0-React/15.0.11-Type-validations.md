...
Salut ! Maintenant qu'on sait faire des formulaires, parlons de la **validation** - le truc le plus **critique** pour éviter les bugs et les failles de sécurité ! 🛡️
...
1. **TypeScript** = sécurité au build, pas au runtime
2. **Zod** = validation runtime + types TS
3. **Parse vs SafeParse** : throw vs return error
4. **Schema-first** = définir une fois, utiliser partout
5. **Validation côté serveur** = OBLIGATOIRE pour la sécurité
6. **Transform** = nettoyer et convertir les données
7. **Refine** = validations métier personnalisées

---

## Mon Conseil Personnel

**Utilise Zod PARTOUT** où tu manipules des données externes :

- ✅ **Formulaires** : validation client + serveur
- ✅ **APIs** : validation des réponses
- ✅ **Config** : variables d'environnement
- ✅ **LocalStorage** : données persistantes
- ✅ **URL params** : paramètres de route
...
**Prochaine étape :** On va voir les **animations** avec Framer Motion et React Spring dans `15.0.12-Animations.md` ! 🎬