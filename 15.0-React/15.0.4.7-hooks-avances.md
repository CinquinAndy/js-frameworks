...
**Hooks avancés** = Les outils des **pros** ! 🚀
...
1. **useLayoutEffect** = synchrone, avant paint, pour éviter les flashs
2. **useId** = IDs uniques pour éviter les conflits
3. **useTransition** = marquer des mises à jour comme non urgentes
4. **useDeferredValue** = différer des valeurs pour éviter les blocages
5. **useImperativeHandle** = exposer des APIs personnalisées via ref
...
### useLayoutEffect
- ✅ Calculs de position (tooltips, menus)
- ✅ Mesures DOM critiques
- ✅ Animations qui doivent être parfaites
- ❌ Pas pour les effets normaux (utilisez useEffect)

### useId
- ✅ Composants réutilisables avec labels/inputs
- ✅ Éviter les conflits d'IDs
- ✅ Formulaires dynamiques
- ❌ Pas pour les keys de React

### useTransition & useDeferredValue
- ✅ Listes très longues
- ✅ Recherche en temps réel
- ✅ Calculs coûteux
- ❌ Pas pour les interactions critiques

### useImperativeHandle
- ✅ Bibliothèques de composants
- ✅ APIs complexes
- ✅ Intégration avec du code non-React
- ❌ Éviter pour les cas normaux
...
- 🆔 [useId Documentation](https://react.dev/reference/react/useId)
...
**Prochaine étape :** Les custom hooks dans `15.0.4.7-custom-hooks.md` ! 🎨
