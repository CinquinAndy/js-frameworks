...
-- Suppression des tables existantes si elles existent (ordre correct)
...
-- Table pour les cotes des matchs (créée AVANT les insertions)
...
SELECT 'Base de données PostgreSQL créée avec succès!' as message;
